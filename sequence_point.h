...
{
	Point data;    /* donne de l'élément de List */
	struct Node_List_Point_* next; /* pointeur sur l'élement suivant */
} Node_List_Point;
...
/*Ecrire le contour dans une fichier*/
void write_contour_in_file(List_Point L, FILE* file);
/*transforme un liste de points en fichier postscrpt*/
