...
#Images choisies pour la sotenance 
#IMAGES_REPORT/lettre-L-cursive.pbm
#IMAGES_REPORT/deux-des-pleins.pbm
#IMAGES_REPORT/Mister_Bean.pbm
#IMAGES_REPORT/JoaquimHock-LesArbres.pbm
#IMAGES_REPORT/Manara.pbm
